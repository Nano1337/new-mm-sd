...
class Generation:
    ...
    def generate(self, inputs):
        ...
        Args:
            inputs (dict): A dictionary containing 'input_ids', 'attention_mask', 'pixel_values', and optionally 'image_sizes'.
        ...
        # Keep image_sizes as a tuple, don't convert to tensor
